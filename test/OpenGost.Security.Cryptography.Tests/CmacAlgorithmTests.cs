...
namespace OpenGost.Security.Cryptography
{
    ...
    {
        [Fact(DisplayName = nameof(CmacAlgorithmTests) + "_" + nameof(SetNullOrEmptyAlgorithmName))]
        ...
        [Fact(DisplayName = nameof(CmacAlgorithmTests) + "_" + nameof(SetUnknownAlgorithmName))]
